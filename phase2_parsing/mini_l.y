...
Declaration:    Ident COLON INTEGER                                                             {printf("Declaration -> Ident COLON INTEGER\n");} 
                ...
                | Ident COLON ENUM L_PAREN Ident R_PAREN INTEGER                                {printf("Declaration -> Ident COLON ENUM L_PAREN Ident R_PAREN INTEGER\n");}
                ;
...
B:      IF Bool_Expr THEN Stmt ENDIF                    {printf("B -> IF Bool_Expr THEN Stmt ENDIF\n");} 
        | IF Bool_Expr THEN Stmt ELSE Stmt ENDIF        {printf("B -> IF Bool_Expr THEN Stmt ELSE Stmt ENDIF\n");}
        ;

C:      WHILE Bool_Expr BEGINLOOP Stmt ENDLOOP      {printf("WHILE Bool_Expr BEGINLOOP Stmt ENDLOOP\n");}
        ;

D:      DO BEGINLOOP Stmt ENDLOOP WHILE Bool_Expr       {printf("DO BEGINLOOP Stmt ENDLOOP WHILE Bool_Expr\n");}
        ;
