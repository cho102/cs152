...
{
       0,    70,    70,    76,    80,   110,   118,   125,   127,   134,
     136,   138,   142,   144,   148,   158,   174,   191,   195,   197,
     213,   229,   231,   236,   252,   268,   283,   289,   304,   310,
     315,   328,   338,   345,   352,   358,   363,   368,   373,   378,
     383,   390,   405,   420,   426,   443,   460,   477,   484,   512,
     523,   528,   557,   568,   580,   596,   606,   619,   632,   650
};
#endif
...
static const char *const yytname[] =
{
  ...
  "Function", "Dec", "Stmt", "Declaration", "Ident", "Statement",
  "E_BRANCH", "Bool_Expr", "Relation_And_Expr", "Relation_Expr",
  "RE_branch", "Comp", "Expression", "Multiplicative_Expr", "Term",
  "Expr_Loop", "Var", "Identifier", YY_NULLPTR
};
#endif
...
{
      -3,     7,    15,    -3,   -37,    25,   -37,   -37,    39,     7,
      26,    38,    44,    52,    61,     7,    56,     7,     7,   -37,
      60,   -37,    64,   -37,    77,     7,    85,    82,    66,    71,
      83,   -37,    76,    19,    27,   -37,     7,     7,    95,    27,
     102,   104,    68,    99,   113,   -37,    19,     3,   -37,   -10,
      40,   -37,    -2,    27,   -37,   -37,    74,   105,    84,    86,
     -37,    80,   -37,   114,   -37,    83,   124,   -37,    83,    19,
      19,   -37,   115,   -37,    19,   -37,    19,    19,    19,    19,
      19,    19,   116,    58,   -37,    83,    27,    27,   -37,   -37,
     -37,   -37,   -37,   -37,    19,     7,   125,    83,   -37,   -37,
     119,   -37,   118,   -37,   -37,   -37,   -37,   -37,   126,   120,
     -37,    14,   -37,   -37,   -37,   -37,   103,   130,   -37,   -37,
      19,   -37,    83,   -37,    27,   -37,   -37,   117,   -37,   -37
};
...
{
       2,     0,     0,     2,    59,     0,     1,     3,     0,     6,
       0,     0,     0,    12,     0,     6,     0,     0,     6,     5,
       0,     9,     0,    13,     0,     0,     0,     0,     0,     0,
       8,    11,     0,     0,     0,    21,     0,     0,     0,     0,
       0,     0,     0,    57,     0,    49,     0,     0,    22,    43,
      47,    48,    57,     0,    32,    33,     0,     0,    26,    28,
      29,     0,    19,    24,    20,     8,     0,     4,     8,     0,
       0,    10,     0,    52,     0,    51,     0,     0,     0,     0,
       0,     0,     0,     0,    30,     8,     0,     0,    37,    39,
      38,    40,    35,    36,     0,     0,     0,     8,     7,    14,
       0,    50,     0,    42,    41,    46,    45,    44,    55,     0,
      34,     0,    25,    27,    31,    23,     0,     0,    58,    53,
       0,    54,     8,    15,     0,    17,    56,     0,    18,    16
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
     -37,   144,   -37,    29,   -31,   -37,   -12,   -37,   -36,   -35,
      62,   -37,    92,   -37,   -21,    50,   -37,    30,   -27,    -1
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,    10,    40,    11,    12,    41,    62,    57,
      58,    59,    60,    94,    61,    49,    50,   109,    51,    52
};
...
{
       5,    64,     1,    42,    66,    23,    73,     4,    13,    63,
      63,     4,    48,    28,    13,     6,    13,    13,    82,    70,
      75,    81,    45,     4,    13,    72,    74,    76,    77,    43,
      45,     4,    83,    14,    96,    43,    43,    98,    42,     8,
     122,    42,    46,   123,    19,     9,    43,    24,    99,   100,
      53,   112,    15,   102,   111,   103,   104,    47,    42,   115,
     108,    16,    54,    55,    43,    47,   117,    43,    63,    18,
      42,    17,    20,   114,    21,    56,    22,    45,     4,    78,
      79,    80,   101,    25,    43,    26,    27,     4,    29,   128,
      31,   127,    30,    32,    43,    42,    43,    53,    33,   108,
      88,    89,    90,    91,    92,    93,    44,    65,    34,    54,
      55,    35,    47,    67,    36,    37,    38,    39,    68,    69,
      70,    43,    88,    89,    90,    91,    92,    93,   105,   106,
     107,    71,    85,    95,    86,    87,    97,   124,   116,   101,
     110,   118,   119,   125,   121,   120,   129,     7,    84,   113,
     126
};

static const yytype_uint8 yycheck[] =
{
       1,    37,     5,    30,    39,    17,     3,     4,     9,    36,
      37,     4,    33,    25,    15,     0,    17,    18,    53,    21,
      47,    23,     3,     4,    25,    46,    23,    37,    38,    30,
       3,     4,    53,     7,    65,    36,    37,    68,    65,    14,
      26,    68,    23,    29,    15,     6,    47,    18,    69,    70,
      23,    86,    14,    74,    85,    76,    77,    38,    85,    95,
      81,    17,    35,    36,    65,    38,    97,    68,    95,     8,
      97,    19,    16,    94,    18,    48,    20,     3,     4,    39,
      40,    41,    24,    23,    85,    21,     9,     4,     3,   124,
      24,   122,    10,    22,    95,   122,    97,    23,    15,   120,
      42,    43,    44,    45,    46,    47,    30,    12,    25,    35,
      36,    28,    38,    11,    31,    32,    33,    34,    14,    51,
      21,   122,    42,    43,    44,    45,    46,    47,    78,    79,
      80,    18,    27,    19,    50,    49,    12,    34,    13,    24,
      24,    22,    24,    13,    24,    19,    29,     3,    56,    87,
     120
};
...
{
       0,     5,    53,    54,     4,    71,     0,    53,    14,     6,
      55,    57,    58,    71,     7,    14,    17,    19,     8,    55,
      16,    18,    20,    58,    55,    23,    21,     9,    58,     3,
      10,    24,    22,    15,    25,    28,    31,    32,    33,    34,
      56,    59,    70,    71,    30,     3,    23,    38,    66,    67,
      68,    70,    71,    23,    35,    36,    48,    61,    62,    63,
      64,    66,    60,    70,    60,    12,    61,    11,    14,    51,
      21,    18,    66,     3,    23,    70,    37,    38,    39,    40,
      41,    23,    61,    66,    64,    27,    50,    49,    42,    43,
      44,    45,    46,    47,    65,    19,    56,    12,    56,    66,
      66,    24,    66,    66,    66,    67,    67,    67,    66,    69,
      24,    56,    61,    62,    66,    60,    13,    56,    22,    24,
      19,    24,    26,    29,    34,    13,    69,    56,    61,    29
};
...
#line 284 "mini_l.y" /* yacc.c:1646  */
    {
                            (yyval.expression).place = strdup((yyvsp[0].expression).code);
                            (yyval.expression).code = strdup((yyvsp[0].expression).place);
                        }
...
#line 651 "mini_l.y" /* yacc.c:1646  */
    {
                            (yyval.expression).code = strdup("");
                            (yyval.expression).place = strdup((yyvsp[0].ident).place);
                        }
