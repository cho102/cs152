...
{
       0,    70,    70,    76,    80,   111,   122,   130,   137,   144,
     151,   164,   179,   191,   196,   207,   216,   232,   248,   265,
     280,   291,   302,   306,   316,   332,   348,   363,   369,   384,
     390,   395,   408,   418,   425,   432,   438,   443,   448,   453,
     458,   463,   470,   485,   500,   506,   523,   540,   557,   564,
     592,   603,   608,   637,   648,   660,   676,   686,   699,   712,
     730
};
#endif
...
static const char *const yytname[] =
{
  ...
  "END_BODY", "BEGINLOOP", "ENDLOOP", "SEMICOLON", "RETURN", "ENUM",
  "COLON", "INTEGER", "COMMA", "ARRAY", "L_SQUARE_BRACKET",
  "R_SQUARE_BRACKET", "L_PAREN", "R_PAREN", "IF", "ELSE", "THEN",
  "CONTINUE", "ENDIF", "OF", "READ", "WRITE", "DO", "WHILE", "TRUE",
  "FALSE", "PLUS", "MINUS", "MULT", "DIV", "MOD", "LT", "LTE", "GT", "GTE",
  "EQ", "NEQ", "NOT", "AND", "OR", "ASSIGN", "$accept", "Program",
  "Function", "FuncIdent", "Dec", "Stmt", "Declaration", "Ident",
  "Statement", "E_BRANCH", "Bool_Expr", "Relation_And_Expr",
  "Relation_Expr", "RE_branch", "Comp", "Expression",
  "Multiplicative_Expr", "Term", "Expr_Loop", "Var", "Identifier", YY_NULLPTR
};
#endif
...
{
       3,    14,    36,     3,   -78,    19,   -78,   -78,    40,    38,
     -78,    42,    39,    48,    44,    64,    38,    46,    38,    38,
     -78,    53,   -78,    59,   -78,    76,    38,    89,    83,    78,
      91,    63,   -78,    70,    17,    80,   -78,    38,    38,   105,
      80,   115,   113,    79,   108,   114,   -78,    17,    22,   -78,
      32,    71,   -78,    33,    80,   -78,   -78,    12,   104,    84,
      86,   -78,    62,   -78,   117,   -78,    63,   121,   -78,    63,
      17,    17,   -78,   116,   -78,    17,   -78,    17,    17,    17,
      17,    17,    17,   118,    77,   -78,    63,    80,    80,   -78,
     -78,   -78,   -78,   -78,   -78,    17,    38,   124,    63,   -78,
     -78,   119,   -78,   120,   -78,   -78,   -78,   -78,   -78,   126,
     122,   -78,     1,   -78,   -78,   -78,   -78,   109,   125,   -78,
     -78,    17,   -78,    63,   -78,    80,   -78,   -78,   110,   -78,
     -78
};
...
{
       2,     0,     0,     2,     5,     0,     1,     3,     0,     7,
      60,     0,     0,     0,    13,     0,     7,     0,     0,     7,
       6,     0,    10,     0,    14,     0,     0,     0,     0,     0,
       0,     9,    12,     0,     0,     0,    22,     0,     0,     0,
       0,     0,     0,     0,    58,     0,    50,     0,     0,    23,
      44,    48,    49,    58,     0,    33,    34,     0,     0,    27,
      29,    30,     0,    20,    25,    21,     9,     0,     4,     9,
       0,     0,    11,     0,    53,     0,    52,     0,     0,     0,
       0,     0,     0,     0,     0,    31,     9,     0,     0,    38,
      40,    39,    41,    36,    37,     0,     0,     0,     9,     8,
      15,     0,    51,     0,    43,    42,    47,    46,    45,    56,
       0,    35,     0,    26,    28,    32,    24,     0,     0,    59,
      54,     0,    55,     9,    16,     0,    18,    57,     0,    19,
      17
};
...
{
     -78,   144,   -78,   -78,    18,   -55,   -78,     6,   -78,   -37,
     -35,    60,   -78,    92,   -78,     4,   -77,   -78,    29,   -25,
      -9
};
...
{
      -1,     2,     3,     5,    11,    41,    12,    13,    42,    63,
      58,    59,    60,    61,    95,    62,    50,    51,   110,    52,
      53
};
...
{
      14,    65,   106,   107,   108,    67,    43,    14,     1,    14,
      14,    97,    64,    64,    99,    46,    10,    14,     4,    83,
      46,    10,    44,    76,    24,    74,    10,   123,    44,    44,
     124,   112,    29,     8,    20,    54,     6,    25,    49,    44,
      47,    43,    10,   118,    43,    75,     9,    55,    56,    15,
      48,    73,   113,    16,    71,    48,    82,    44,    84,   116,
      44,    43,    21,    18,    22,    17,    23,    10,   128,    77,
      78,    64,    19,    43,   100,   101,    26,    44,    34,   103,
      27,   104,   105,    46,    10,    28,   109,    44,    35,    44,
     129,    36,    30,    31,    37,    38,    39,    40,    43,   115,
      45,   102,    32,    54,    89,    90,    91,    92,    93,    94,
      79,    80,    81,    33,    44,    55,    56,    66,    48,    89,
      90,    91,    92,    93,    94,   109,    68,    69,    57,    71,
      70,    86,    72,    98,    87,    88,    96,   117,   126,   130,
     102,   119,   111,   125,   120,   121,   122,     7,   114,    85,
     127
};

static const yytype_uint8 yycheck[] =
{
       9,    38,    79,    80,    81,    40,    31,    16,     5,    18,
      19,    66,    37,    38,    69,     3,     4,    26,     4,    54,
       3,     4,    31,    48,    18,     3,     4,    26,    37,    38,
      29,    86,    26,    14,    16,    23,     0,    19,    34,    48,
      23,    66,     4,    98,    69,    23,     6,    35,    36,     7,
      38,    47,    87,    14,    21,    38,    23,    66,    54,    96,
      69,    86,    16,    19,    18,    17,    20,     4,   123,    37,
      38,    96,     8,    98,    70,    71,    23,    86,    15,    75,
      21,    77,    78,     3,     4,     9,    82,    96,    25,    98,
     125,    28,     3,    10,    31,    32,    33,    34,   123,    95,
      30,    24,    24,    23,    42,    43,    44,    45,    46,    47,
      39,    40,    41,    22,   123,    35,    36,    12,    38,    42,
      43,    44,    45,    46,    47,   121,    11,    14,    48,    21,
      51,    27,    18,    12,    50,    49,    19,    13,    13,    29,
      24,    22,    24,    34,    24,    19,    24,     3,    88,    57,
     121
};
...
{
       0,     5,    53,    54,     4,    55,     0,    53,    14,     6,
       4,    56,    58,    59,    72,     7,    14,    17,    19,     8,
      56,    16,    18,    20,    59,    56,    23,    21,     9,    59,
       3,    10,    24,    22,    15,    25,    28,    31,    32,    33,
      34,    57,    60,    71,    72,    30,     3,    23,    38,    67,
      68,    69,    71,    72,    23,    35,    36,    48,    62,    63,
      64,    65,    67,    61,    71,    61,    12,    62,    11,    14,
      51,    21,    18,    67,     3,    23,    71,    37,    38,    39,
      40,    41,    23,    62,    67,    65,    27,    50,    49,    42,
      43,    44,    45,    46,    47,    66,    19,    57,    12,    57,
      67,    67,    24,    67,    67,    67,    68,    68,    68,    67,
      70,    24,    57,    62,    63,    67,    61,    13,    57,    22,
      24,    19,    24,    26,    29,    34,    13,    70,    57,    62,
      29
};
...
#line 152 "mini_l.y" /* yacc.c:1646  */
    {
                            std::string temp;
                            if(varTemp.find((yyvsp[-2].expression).place)){
                                printf("ERROR: %s has already been defined\n" , (yyvsp[-2].expression).place);
                            }
                            else {
                                varTemp.insert((yyvsp[-2].expression).place);
                                temp += ". " + (yyvsp[-2].expression).place + "\n"; 
                            }
                            (yyval.expression).code = strdup(temp.c_str());
...
#line 165 "mini_l.y" /* yacc.c:1646  */
    {
                            int num = (yyvsp[-3].num_val);
                            if (num <= 0){
                                printf("ERROR: Declaring an array of size <= 0\n");
                            }
                            if(varTemp.find((yyvsp[-7].expression).place)){
                                printf("ERROR: %s has already been defined\n" , (yyvsp[-7].expression).place);
                            }
                            else {
                                varTemp.insert((yyvsp[-7].expression).place);
                                temp += ".[] " + (yyvsp[-7].expression).place + ", " + num + "\n"; 
                            }
                            (yyval.expression).code = strdup(temp.c_str());
                        }
...
#line 180 "mini_l.y" /* yacc.c:1646  */
    {/*TODO*/
                            if(varTemp.find((yyvsp[-5].expression).place)){
                                printf("ERROR: %s has already been defined\n" , (yyvsp[-5].expression).place);
                            }
                            else {
                                varTemp.insert((yyvsp[-5].expression).place);
                            }
                            (yyval.expression).code = strdup(temp.c_str());
                        }
...
#line 2153 "mini_l.tab.c" /* yacc.c:1646  */
    break;
...
#line 2188 "mini_l.tab.c" /* yacc.c:1646  */
    break;
...
#line 2202 "mini_l.tab.c" /* yacc.c:1646  */
    break;
...
#line 2234 "mini_l.tab.c" /* yacc.c:1646  */
    break;
...
#line 2263 "mini_l.tab.c" /* yacc.c:1646  */
    break;
